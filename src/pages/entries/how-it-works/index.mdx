...
<aside>
  <p>Lift($$L$$) can be determined by Lift Coefficient ($$C_L$$) like the following equation.</p>
</aside>
...
<Img src="mean_variance.svg" browserBorder />
